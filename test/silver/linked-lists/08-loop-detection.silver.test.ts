import { detectLoop, Node } from '../../../src/linked-lists/08-loop-detection';

describe('detectLoop', () => {
  test('returns null if the list has only one node', () => {
    const node: Node<number> = { value: 1 };
    const result = detectLoop(node);
  ...
  test('returns null if the list does not have a loop', () => {
    ...
    const list: Node<number> = {
      value: 1,
      next: { value: 2, next: { value: 3, next: { value: 4, next: { value: 5 } } } },
    };
        ...
        next: {
          ...
          next: {
            ...
            next: {
              ...
              next: {
                value: 6,
                next: { value: 7, next: { value: 8, next: { value: 9, next: loopNode } } },
              },
            },
          },
        },
          ...
          next: {
            ...
            next: {
              ...
              next: {
                ...
                next: {
                  value: 7,
                  next: { value: 8, next: { value: 9, next: { value: 10, next: loopNode } } },
                },
              },
            },
          },
