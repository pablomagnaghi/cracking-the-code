import { deleteMiddleNodeByPosition, Node } from '../../../src/linked-lists/23-delete-middle-node';
...
describe("deleteMiddleNodeByPosition", () => {
  test("deletes middle node at position 1", () => {
    ...
    const result = deleteMiddleNodeByPosition(node, 1);
  ...
  test("no deletion if position is out of range", () => {
    ...
    const result = deleteMiddleNodeByPosition(head, 4);
